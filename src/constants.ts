import {Extra} from "./interfaces.js";
...
export const attributesNames = ['Status','Responsible','Deadline','Place'];

export const deadLineAttributes = ['Without date','Expired','Expires within 24 hours','Expires within a week'];

export const attributes = ['todo','completed'];

export const extraFields: Extra[] = ['deadline', 'responsible', 'place'];
